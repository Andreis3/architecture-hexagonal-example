...
import (
	...
	application "github.com/andreis3/go-hexagonal/application"
...
// MockProductServideInterface is a mock of ProductServideInterface interface.
type MockProductServideInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductServideInterfaceMockRecorder
}

// MockProductServideInterfaceMockRecorder is the mock recorder for MockProductServideInterface.
type MockProductServideInterfaceMockRecorder struct {
	mock *MockProductServideInterface
}

// NewMockProductServideInterface creates a new mock instance.
func NewMockProductServideInterface(ctrl *gomock.Controller) *MockProductServideInterface {
	mock := &MockProductServideInterface{ctrl: ctrl}
	mock.recorder = &MockProductServideInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductServideInterface) EXPECT() *MockProductServideInterfaceMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockProductServideInterface) Create(name string, price float64) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServideInterfaceMockRecorder) Create(name, price interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProductServideInterface)(nil).Create), name, price)
}

// Disable mocks base method.
func (m *MockProductServideInterface) Disable(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Disable indicates an expected call of Disable.
func (mr *MockProductServideInterfaceMockRecorder) Disable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disable", reflect.TypeOf((*MockProductServideInterface)(nil).Disable), product)
}

// Enable mocks base method.
func (m *MockProductServideInterface) Enable(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable indicates an expected call of Enable.
func (mr *MockProductServideInterfaceMockRecorder) Enable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enable", reflect.TypeOf((*MockProductServideInterface)(nil).Enable), product)
}

// Get mocks base method.
func (m *MockProductServideInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductServideInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductServideInterface)(nil).Get), id)
}
